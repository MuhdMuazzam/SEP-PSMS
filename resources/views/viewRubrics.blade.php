...
@section('content')
 <div>
 <form action="/data/{{$rubrics_data->id}}/update" method="POST">
         {{csrf_field()}}
	<br>
	...
	<input type="text" class="form-control" name="RubricsName" placeholder="Rubrics Name"value="{{$rubrics_data->RubricsName}}">
	</div>
	<div class="mb-3" >
	<label for="RubricsDesc" class="form-label">Description</label>
	<input type="text" class="form-control" name="RubricsDesc" placeholder="Rubrics Desc"value="{{$rubrics_data->RubricsDesc}}">
	</div>	</div>

	<div class="col-6">
	<div class="mb-3"style="margin-left:50px">
 	 <label for="RubricsDate" class="form-label">Date</label>
	<input type="text" class="form-control" name="RubricsDate" placeholder="Date"value="{{$rubrics_data->RubricsDate}}">
	</div>
	<div class="mb-3"style="margin-left:50px">
 	 <label for="RubricsSession" class="form-label">Session</label>
	<input type="text" class="form-control" name="RubricsSession" placeholder="Session"value="{{$rubrics_data->RubricsSession}}">
	</div>
...
<ul class="input" id="input"style="margin-top:20px;margin-left:-20px">
	<li>
		<textarea name="Criteria" id="" cols="26" rows="4"value="">{{$rubrics_data->Criteria}}</textarea>
	</li>
	<li style="margin-left:30px;border:1px solid lightblue">
		<ul class="column">
			<li >
			<textarea name="Scale1" id="Scale1" cols="12" rows="4" value="">{{$rubrics_data->Scale1}}</textarea>
			</li>
		</ul>
	</li>
	<li>
		<ul class="column">
			<li>
			<textarea name="Scale2" id="Scale2" cols="12" rows="4"value="">{{$rubrics_data->Scale2}}</textarea>
			</li>
		</ul>
	</li>
	<li>
		<ul class="column">
		<li>
			<textarea name="Scale3" id="Scale3" cols="12" rows="4"value="">{{$rubrics_data->Scale3}}</textarea>
			</li>
		</ul>
	</li>
	<li>
		<ul class="column">
		<li>
			<textarea name="Scale4" id="Scale4" cols="12" rows="4"value="">{{$rubrics_data->Scale4}}</textarea>
			</li>
		</ul>
	</li>
	<li style="margin-right:50px;">
		<ul class="column">
		<li>
			<textarea name="Scale5" id="Scale5" cols="12" rows="4"value="">{{$rubrics_data->Scale5}}</textarea>
			</li>
		</ul>
	</li>
    <li style="border:1px solid lightblue">
		...
		<li style="padding-right:25px;padding-left:25px"><br>
				<input type="text" name="weightage"value="{{$rubrics_data->weightage}}" id="weightage"style="width:220%;margin-left:-20px;float:left;padding-right:50px">
			</li>
		</ul>
	</li>
    <li>
		<ul class="column">
			<li style="padding-right:30px;padding-left:30px"><br>
				<input type="text" name="marks" id="marks" value="{{$rubrics_data->marks}}" style="width:220%;margin-left:-20px;float:left;padding-right:50px">
			</li>
		</ul>
	</li>
    <li>
		...
		<li style="padding-right:30px;padding-left:40px"><br>
				<input type="text" name="final" id="final" value="{{$rubrics_data->final}}"style="width:220%;margin-left:-20px;float:left;padding-right:50px">
			</li>
		</ul>
	</li>
</ul>
...
<div>
	...
	<div class="text-center">
			<input type="submit" value="Update" class="btn-success" style="padding:10px;margin-left:50px;width:50%" />
	</div>
</div>
</div>
</form>
