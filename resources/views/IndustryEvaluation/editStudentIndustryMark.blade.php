...
<p class="h2">Edit Industry Evaluation Mark</p>
...
<form action="/indAddMark/{id}/edit" method="POST">
        @csrf
    ...
    <div class="table-form">
        <br>
        <div class="row-form">
            <div class="col-form col-left">Edit Mark</div>
            <div class="col-form col-center">=</div>
            <div class="col-form col-right"><input type="number" step="0.01" name="editTotalMark" size="5" id="inputMark"></div>
        </div>
        <br>
        <div class="row-form">
            <div class="col-form col-left">Edit Comment</div>
            <div class="col-form col-center">=</div>
            <div class="col-form col-right"><textarea name="editComment" rows="4" cols="50"></textarea></div>
        </div>
        <br>
